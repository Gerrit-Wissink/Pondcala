...
type GameTurn struct {
	...
	HostPonds     []int     `json:"host_ponds" gorm:"not null"`
	OpponentPonds []int     `json:"opponent_ponds" gorm:"not null"`
	HostScore     int       `json:"host_score" gorm:"not null"`
	OpponentScore int       `json:"opponent_score" gorm:"not null"`
